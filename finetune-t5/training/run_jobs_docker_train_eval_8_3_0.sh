...
"${MIXTURE}" \
"${DATA_ROOT}/p3_c4_document_level_chosen_examples/30aug_shuffled" \
0.0001 \
4 \
10 \
"google/t5-base-lm-adapt" \
"${TRAINING_SRC_ROOT}/perceiver_configs/xattn_multi_aug_config_v1_v3_5aug.json" \
"${OUTPUT_SRC_ROOT}/p3_finetuning/8_3_multitask_mixture_mulcqa_n_2_c4_5percent_5aug_latent_64" \
"not_using_wandb" \
...
echo "done shuffled 5aug latent 64"
