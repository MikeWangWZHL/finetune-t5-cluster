...
"${OUTPUT_SRC_ROOT}/p3_finetuning/run_jobs_docker_train_eval_8_15_0__1aug_latent_64/8_15_0__1aug_latent_64" \
"not_using_wandb" \
...
do
    ...
    "${DATA_ROOT}/p3_c4_document_level_chosen_examples/30aug" \
    "${OUTPUT_SRC_ROOT}/p3_finetuning/run_jobs_docker_train_eval_8_15_0__1aug_latent_64/8_15_0__1aug_latent_64" \
    "${OUTPUT_SRC_ROOT}/eval/run_jobs_docker_train_eval_8_15_0__1aug_latent_64/8_15_0__1aug_latent_64/${TASK_NAME}" \
    ${CUDA_VISIBLE_DEVICES} \
    ${MAIN_PROCESS_PORT} \
    ${NUM_PROCESSES} \
    8 # eval batch size
