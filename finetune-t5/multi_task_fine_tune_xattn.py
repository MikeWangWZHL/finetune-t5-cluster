...
def main():
    ...
    if args.model_architecture == 'fusionOnDecoder':
        ...
        logger.info("init model with double gate!!!")
        model_class_name = T5ForConditionalGenerationMultiAug_DoubleGated
    elif args.model_architecture == 'SharedEncoderDecoder_MultiAug_AugScore':
        logger.info("init model with augmentation score!!!")
        model_class_name = T5ForConditionalGenerationMultiAug_AugScore
